...
WHERE
    DATEADD(MONTH, InHouse_Training.IH_Training_Valid_Duration, InHouse_Training.IH_Training_Date) < GETDATE()
UNION ALL
SELECT 
    Employee.Emp_Num,
    Employee.Emp_First_Name,
    ...
    DATEADD(MONTH, Regulatory_Training.R_Training_Valid_Duration, Regulatory_Training.R_Training_Date) AS R_Training_Expiry_Date
FROM 
    Employee 
JOIN 
    Regulatory_Training
...
WHERE
    DATEADD(MONTH, Regulatory_Training.R_Training_Valid_Duration, Regulatory_Training.R_Training_Date) < GETDATE();